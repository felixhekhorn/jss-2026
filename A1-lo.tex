...
\begin{exercisebox}[label=box:exAT1]{Step 1}
    Proof
    \begin{align}
...
\end{equation}
\begin{exercisebox}[label=box:exAT2]{Step 2}
    Proof
    \begin{align}
...
\begin{exercisebox}[label=box:exAT3]{Step 3}
    Proof
    \begin{align}
...
\begin{exercisebox}[label=box:exAT4]{Step 4}
    Proof
    \begin{align}
...
\begin{exercisebox}[label=box:exAWard]{Step 5: Ward identity}
    Proof
    \begin{equation}
...
\begin{exercisebox}{Step 8}
    Proof
    \begin{equation}
        L^\gamma_{\mu\nu} \hat W^{\mu\nu}_{\gamma q} = 2\qty(g_{V}^{\gamma q})^2\frac{Q^4}{z^2 y^2}\left(2-2y + y^2\right) \label{eq:LOsigma}
    \end{equation}
