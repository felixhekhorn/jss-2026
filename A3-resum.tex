...
\begin{enumerate}
    ...
    \item Insert this expansion into \cref{eq:NLOalphast} and expand $\alpha_s^\text{NLO}(t_R)$ to the same accuracy. Recall $\ln(1 + w \epsilon) = w \epsilon + \order{\epsilon^2}$.
