...
This is a pure coincidence only valid in the simplest case at LO.
When studying older literature this can, however, lead to confusion as, e.g., PDFs may be called \enquote{structure functions}, or what we talk about when we denote a general variable \enquote{$x$}.
