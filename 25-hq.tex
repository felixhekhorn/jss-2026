...
Here, the probed scale $Q$ does not matter, but we will use the same coefficient functions for any scale.
...
When we consider a finite mass we eventually have three different scales in our diagrams: the total energy of the colliding particles $\hat s$, the photon virtuality $Q^2$, and the quark mass $m^2$.
