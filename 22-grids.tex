...
\begin{description}
    ...
    \item[order] This is the list of perturbative orders, i.e.\ we store each $\vb C^{(k)}(z)$, \cref{eq:CpQCD}, separately.
        ...
        Recall that LO, \cref{eq:LObarCq}, and NLO, e.g.\ \cref{eq:NLOCq}, are quite different and this generates correlations with the momentum fraction dimension (see below).
